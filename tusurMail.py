...
import time
#теста осуществляется через командную строку, браузер chrome
...
# при ошибке в ЖЦ теста необходимо сделать скриншот и сохранить html страницы
